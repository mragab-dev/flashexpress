import { User, Shipment, UserRole, Zone, ShipmentStatus, PaymentMethod, ClientTransaction, Notification, FinancialSettings, CourierStats, CommissionType, CourierTransaction, ShipmentPriority } from './types';
...
export const mockUsers: User[] = [
  ...
  { 
    ...
    priorityMultipliers: {
      [ShipmentPriority.STANDARD]: 1.0,
      [ShipmentPriority.URGENT]: 1.8,
      [ShipmentPriority.EXPRESS]: 2.5,
    },
...
export const mockShipments: Shipment[] = [
  ...
  },
  {
    ...
    packageValue: 3000,
    clientFlatRateFee: 75,
    courierCommission: 30,
  },
  {
    id: 'FLS764981', // Make one ID static for testing tracking and fixing wallet issue
    clientId: 4,
    clientName: 'Client Alice',
...
export const mockCourierStats: CourierStats[] = [
    { courierId: 6, deliveriesCompleted: 45, deliveriesFailed: 2, totalEarnings: 685.00, pendingEarnings: 45.00, currentBalance: 640.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 0, isRestricted: false, performanceRating: 4.7 },
    { courierId: 7, deliveriesCompleted: 80, deliveriesFailed: 10, totalEarnings: 1200.00, pendingEarnings: 200.00, currentBalance: 1000.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 1, isRestricted: false, performanceRating: 4.2 },
    { courierId: 8, deliveriesCompleted: 20, deliveriesFailed: 5, totalEarnings: 250.00, pendingEarnings: 0, currentBalance: 250.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 2, isRestricted: true, restrictionReason: 'Performance rating too low', performanceRating: 1.8 },
    { courierId: 9, deliveriesCompleted: 150, deliveriesFailed: 3, totalEarnings: 2500.00, pendingEarnings: 500.00, currentBalance: 2000.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 0, isRestricted: false, performanceRating: 4.9 },
    { courierId: 10, deliveriesCompleted: 35, deliveriesFailed: 1, totalEarnings: 520.00, pendingEarnings: 75.00, currentBalance: 445.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 0, isRestricted: false, performanceRating: 4.8 },
    { courierId: 11, deliveriesCompleted: 62, deliveriesFailed: 4, totalEarnings: 895.00, pendingEarnings: 120.00, currentBalance: 775.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 0, isRestricted: false, performanceRating: 4.5 },
    { courierId: 12, deliveriesCompleted: 28, deliveriesFailed: 2, totalEarnings: 410.00, pendingEarnings: 45.00, currentBalance: 365.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 0, isRestricted: false, performanceRating: 4.6 },
    { courierId: 13, deliveriesCompleted: 91, deliveriesFailed: 8, totalEarnings: 1340.00, pendingEarnings: 180.00, currentBalance: 1160.00, commissionType: CommissionType.FLAT, commissionValue: 30, consecutiveFailures: 0, isRestricted: false, performanceRating: 4.3 },
];
