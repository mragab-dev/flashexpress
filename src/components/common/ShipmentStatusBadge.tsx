...
export const ShipmentStatusBadge: React.FC<{ status: ShipmentStatus }> = ({ status }) => {
    const statusStyles: Record<ShipmentStatus, string> = {
        [ShipmentStatus.PENDING_ASSIGNMENT]: 'bg-yellow-100 text-yellow-800',
        ...
        [ShipmentStatus.RETURN_REQUESTED]: 'bg-orange-100 text-orange-800',
        [ShipmentStatus.RETURN_IN_PROGRESS]: 'bg-fuchsia-100 text-fuchsia-800',
